      ...
      >
        <div className="space-y-4 sm:space-y-6">
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold tracking-tight animate-fade-in text-foreground">
            <span className="inline-block animate-slide-up" style={{ animationDelay: '0.1s' }}>Israel Pina</span>
          </h1>
          <div className="h-px w-24 sm:w-32 mx-auto bg-foreground/30 animate-scale-in" style={{ animationDelay: '0.3s' }} />
          <p className="text-xl sm:text-2xl md:text-3xl text-foreground/80 font-light tracking-wide animate-fade-in" style={{ animationDelay: '0.5s' }}>
